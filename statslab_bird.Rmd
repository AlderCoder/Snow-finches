...
We get an accuracy around **84 %**, but this may only be due to the fact that we had to omit the test data with NAs and therefore we had less test data compared to the decision tree.
